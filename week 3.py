...
<ipython-input-24-4c1eb3163e1b> in <module>
      4     return even
      5 
...
---------------------------------------------------------------------------
TypeError                                 Traceback (most recent call last)
<ipython-input-17-18c55cccba97> in <module>
      5     return round((1 / 3) * pi * r * r * h)
      6 
----> 7 radius = float(input("Enter value of radius= "))
      8 height = float(input("Enter value of height= "))
      9 
